...
colormap = st.sidebar.selectbox("Colormap", ["gray", "viridis", "plasma", "magma", "inferno"], help="Select colormap for image display.")
...
```
    ...
    with col2:
        st.image(sobel_edges, caption="Sobel Edges", use_column_width=True, clamp=True, channels="GRAY")
    with col3:
        st.image(canny_edges, caption="Canny Edges", use_column_width=True, clamp=True, channels="GRAY")
    ...
    with col1:
        st.image(img, caption="Original Image", use_column_width=True, clamp=True, channels="GRAY")
    with col2:
        st.image(otsu_thresh, caption="Otsu Thresholded Image", use_column_width=True, clamp=True, channels="GRAY")
```
